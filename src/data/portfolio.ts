...
export const projects: Project[] = [
  ...
  },
  {
    ...
    sourceUrl: "#",
    swaggerUrl: "https://izzy-movie-watchlist.onrender.com/api/v1/docs",
  },
  {
    title: "ShipShield",
    image:
    ...
    // swaggerUrl: "https://squad-hackathon-verifi-backend.onrender.com",
  },
  {
    title: "VirtuCare",
    image:
  ...
  },
  {
    title: "VendorShield",
    image:
      "https://res.cloudinary.com/craftshop/image/upload/v1789989713/Screenshot_2026-09-21_122123_ttmw6e.png",
    tags: ["NestJS", "TypeScript", "PostgreSQL", "Squad"],
    description:
      "A team-based project built during Squad Hackathon 3.0 to help businesses verify and manage vendors with a focus on trust, transparency, and secure transactions. I worked on the backend, building APIs and implementing the core application logic.",
    demoUrl: "https://squad-hackathon-verifi.vercel.app/",
    sourceUrl: "",
    swaggerUrl: "https://squad-hackathon-verifi-backend.onrender.com/api/docs",
  },
  {
    title: "TaskFlow",
    image:
...
export const experience: ExperienceItem[] = [
  {
    role: "Backend Software Engineer (Freelance)",
    company: "Pedxo",
    period: "July 2025 – Present",
    icon: "ri-code-box-line",
    points: [
      "Developing and maintaining the Pedxo Talent backend using NestJS and TypeScript",
      "Building RESTful APIs, authentication, authorization, and core business logic",
      "Contributing to Pedxo Pay, a dedicated service for talent payments and user account funding",
      "Implementing database operations and service integrations for reliable and scalable backend systems",
    ],
  },
  {
...
export const education = {
  ...
  logoImage:
    "https://res.cloudinary.com/craftshop/image/upload/v1789984115/logo_mtypsj.jpg",
  achievements: [
...
export const certifications = [
  ...
  // { title: 'React Developer Certification', issuer: 'Meta, 2023' },
  {
    ...
    issuer: "MongoDB University, 2023",
  },
  { title: "Full Stack Web Development", issuer: "Nithub, 2024" },
];
